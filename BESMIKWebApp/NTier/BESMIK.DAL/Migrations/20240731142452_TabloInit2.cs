...
{
    /// <inheritdoc />
    public partial class TabloInit2 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Email = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    EmployeesNumber = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    EstablishmentYear = table.Column<DateOnly>(type: "date", nullable: false),
                    ContractStartYear = table.Column<DateOnly>(type: "date", nullable: true),
                    ContractEndYear = table.Column<DateOnly>(type: "date", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
